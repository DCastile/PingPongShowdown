...
async.parallel([
	...
	// pull data when player was Red2PlayerID
	function(callback) {

		var params = {				
			TableName: matchKeeperMatchesTable,
			IndexName: "Red2PlayerIDIndex",
			KeyConditionExpression: "Red2PlayerID = :PlayerID1",    
			ExpressionAttributeValues: {
				":PlayerID1": phone     
			},
			ProjectionExpression: "MatchData"
	...
	// pull data when player was Blue2PlayerID
	function(callback) {

		var params = {				
			TableName: matchKeeperMatchesTable,
			IndexName: "Blue2PlayerIDIndex",
			KeyConditionExpression: "Blue2PlayerID = :PlayerID1",    
			ExpressionAttributeValues: {
				":PlayerID1": phone     
			},
			ProjectionExpression: "MatchData"
